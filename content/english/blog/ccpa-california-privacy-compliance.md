...
description: "A plain-English guide to CCPA and CPRA compliance — who must comply, the consumer rights you must honor, business obligations, penalties, and how to get compliant."
date: 2025-06-14
image: "/images/blog/ccpa-california-privacy-compliance.webp"
categories: ["Compliance"]
author: "Secure Techies"
tags: ["CCPA", "CPRA", "data privacy", "compliance", "California privacy law"]
draft: false
faq:
  - question: "What is the CCPA?"
    answer: "The CCPA — California Consumer Privacy Act — is a state privacy law that gives California residents rights over the personal information businesses collect about them. It took effect in 2020 and was significantly strengthened by the CPRA (California Privacy Rights Act), whose provisions became enforceable in 2023. Together they give consumers the right to know what data is collected, to delete it, to correct it, and to opt out of the sale or sharing of their personal information, while imposing obligations on businesses that handle that data."
  - question: "Does my business have to comply with CCPA?"
    answer: "The CCPA applies to for-profit businesses that do business in California and meet at least one of three thresholds: annual gross revenue over 25 million dollars; buying, selling, or sharing the personal information of 100,000 or more California consumers or households per year; or deriving 50 percent or more of annual revenue from selling or sharing consumers' personal information. You don't have to be based in California — if you handle Californians' data and cross a threshold, it can apply to you."
  - question: "What rights does the CCPA give consumers?"
    answer: "California consumers have several key rights: the right to know what personal information a business collects and how it's used; the right to delete personal information a business has collected; the right to correct inaccurate personal information; the right to opt out of the sale or sharing of their personal information; and the right to non-discrimination for exercising these rights, meaning a business can't penalize them for it. The CPRA also added rights around limiting the use of sensitive personal information."
  - question: "What are the penalties for CCPA violations?"
    answer: "The California Privacy Protection Agency and the Attorney General can levy fines of up to 2,500 dollars per unintentional violation and up to 7,500 dollars per intentional violation or violation involving minors. Because each affected consumer can count as a separate violation, totals can climb quickly. There's also a private right of action allowing consumers to sue over certain data breaches involving non-encrypted personal information, with statutory damages even without proving actual harm."
  - question: "What's the difference between CCPA and CPRA?"
    answer: "The CCPA is the original 2018 law that took effect in 2020. The CPRA, passed by ballot initiative in 2020 with enforcement beginning in 2023, amended and expanded it — adding new consumer rights like correction and limiting use of sensitive data, creating a dedicated enforcement agency (the California Privacy Protection Agency), and tightening business obligations. People often use 'CCPA' loosely to refer to the combined, current California privacy framework, which is really CCPA as amended by CPRA."
  - question: "How can a business become CCPA compliant?"
    answer: "The core steps are: map what personal data you collect and where it lives; update your privacy policy to disclose collection, use, and consumer rights; provide clear mechanisms for consumers to exercise their rights, including a 'Do Not Sell or Share My Personal Information' option where applicable; build a process to respond to consumer requests within required timeframes; secure the data you hold with reasonable safeguards; and train staff to handle requests. Many businesses work with a compliance partner to set this up correctly."
---
...
![A person reviewing privacy settings and data on a laptop](/images/blog/ccpa-california-privacy-compliance-2.webp "California privacy law applies based on whose data you handle, not where your business is located")
...
1. **Know your data.** You can't protect or disclose what you can't see. Map what personal information you collect, where it comes from, where it's stored, who has access, and who you share it with. This data inventory is the foundation of everything else.
2. **Update your privacy policy.** Your public privacy notice must clearly disclose what you collect, why, how it's used, who it's shared with, and what rights consumers have — and it needs to stay current.
3. **Provide ways to exercise rights.** Give consumers clear, accessible methods to make requests — typically a webform, an email address, and where applicable a "Do Not Sell or Share My Personal Information" link.
4. **Respond to requests on time.** You generally must confirm receipt quickly and respond substantively within 45 days (extendable in some cases). You need a real internal process for this, not ad hoc scrambling.
5. **Verify requesters.** Before handing over or deleting data, you must reasonably verify the person is who they claim to be, so you don't accidentally disclose data to an imposter.
6. **Secure the data.** The law expects "reasonable security." If you suffer a breach of unencrypted personal information due to inadequate safeguards, you face heightened liability — more on that next.
7. **Train your people.** Staff who handle consumer requests or personal data need to know the rules and the process.
...
![Server and network infrastructure representing secure data storage](/images/blog/ccpa-california-privacy-compliance-3.webp "Reasonable security safeguards are both a legal expectation and your best defense against breach liability")
