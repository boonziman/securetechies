...
benefits:
  ...
  items:
    - icon: "lock"
      ...
      text: "Full-disk encryption, secure email, and strict access controls so privileged client data stays privileged — and you can prove it."
    - icon: "shield"
      title: "Built for Legal Threats"
      text: "Ransomware protection, dark-web monitoring, phishing defense, and staff training tuned to the attacks that specifically target law firms."
    - icon: "headset"
      title: "Real Humans, Fast"
      text: "Average response under two hours from senior engineers who understand confidentiality and deadlines — not a faceless ticket queue."
    - icon: "doc"
      title: "Audit-Ready Compliance"
      text: "We produce the documentation your cyber-insurer, clients, and ethics obligations require — so security questionnaires stop being a fire drill."
    - icon: "money"
      title: "Flat, Predictable Pricing"
      text: "One transparent monthly rate. No 'out of scope' surprises. You'll know exactly what you pay and why — easy to bill back and budget."
    - icon: "chart"
